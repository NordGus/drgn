...
| role       | integer (enum)           | index, not null, default 0 | Require for ActiveRecord enum to indicate the role of the character on the platform, (support: 0, dungueon_master: 99)                                                      |
